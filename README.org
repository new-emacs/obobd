...
* MONDRIAN 介绍
   ...
   - Mondrian 4.0 文档 http://mondrian.pentaho.com/head/documentation/schema.php
...
[2015-10-22 四 12:37]
 ...
 获得所有用户信息 /saiku/rest/saiku/admin/users
#+begin_src 

[
{"username":"admin","email":"test@admin.com","password":"admin","roles":["ROLE_USER","ROLE_ADMIN"],"id":1},
{"username":"smith","email":null,"password":"smith","roles":null,"id":4}
]

#+end_src

根据ID获得用户信息/saiku/rest/saiku/admin/users/5
